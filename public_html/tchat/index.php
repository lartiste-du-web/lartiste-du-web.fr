...
<html>
    <head>
        <title>L'artiste Du Web | Tchat</title>
        <meta charset="UTF-8">
    ...
    <body>
        <div id="messages-container">
            <div>
                <div id="scroll-message" class="div-tchat">
            ...
            <form id="message-form" class="form">
                <?php
                    if($CONNECTED) {
                ?>
                    <textarea type="text" name="message" required class="input-message" autocomplete="off" placeholder="Envoyer un message dans le tchat"></textarea>
                    <input type="submit" name="valider" class="input-envoyer">
                <?php
                    } else {
                ?>
                    <input type="text" name="message" required disabled title="Connectez vous ou inscrivez vous pour envoyer des messages" class="input-message" autocomplete="off" placeholder="Connectez vous ou inscrivez vous pour envoyer des messages">
                    <input type="button" value="Envoyer" name="valider" class="input-envoyer">
                <?php
                    }
                ?>
            </form>
